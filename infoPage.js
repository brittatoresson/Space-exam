...
function updateUI(item) {
  //Addera mellanrum mellan månar i mån-arrayen
  //   let moons = item.moons;
  //   moons = moons.join(", ");
  //Skap article och appenda till planetInfo-article
...
function nextMoon(planet) {
  ...
  for (moon of moonArray) {
    //Ta ut 4 första elementen från moon-array och pusha in i ny lista (lsitOne). Orginalarrayen blir koratre, samma procedur upprpas till arrayLengt = 0.
    moonListOne.push(moonArray.splice(0, 3));
...
//Paginering av månarna MHA MAJA
// function nextMoon(planet) {
//     //Rensa UI
//     moonDisplay.innerHTML = "";
//     //Variabler
...
//     // Loopa igenom månarray
//     for (moon of moonArray) {
//       //bracket notation - för att nå prpoerty i ett obj
//       listI++;
//       //Ta ut 4 första från moon-array och lägga in i ny lista. Orginalarrayen blir koratre
//       listOne[listI] = moonArray.splice(0, 4);
//       //Uppdatera UI med månar
//       if (moon) {
//         moonDisplay.innerHTML = `Månar: ${listOne[listI]}`;
//         break;
//       }
//     }
//   }
